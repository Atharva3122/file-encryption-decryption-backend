...
smtp_email = 'ameyvaikar@gmail.com'
smtp_password = 'ASV@17avv#05'
...
# def sendMail(request, image_path):
#     name = request.form['name']
#     # message['To'] = request.form['email']
#     message['To'] = "aditya.kumar3006@gmail.com"

#     message['Subject'] = name + " has sent you an image. "
